  ...
  Future<void> updateHistoryItem(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('فشل في التحديث: ${response.statusCode} - ${response.body}'.tr()),
                ...
                List<dynamic> getAvailableProducts(int currentIndex) {
                  return allProducts.where((product) {
                    ...
                    for (int i = 0; i < newItems.length; i++) {
                      if (i != currentIndex && 
                          newItems[i]['product']['_id'] == productId) {
                        return false;
                      }
                    }
                      ...
                      child: ConstrainedBox(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            // المنتجات الحالية (غير قابلة للتعديل أو الإضافة)
                            Text(
                              'المنتجات الحالية'.tr(),
                              style: GoogleFonts.cairo(
                            ...
                            Container(
                              ...
                              child: newItems.isEmpty
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  if (newItem['product']['_id']?.isNotEmpty == true) {
                                            ...
                                            onChanged: (String? newValue) {
                                              setState(() {
                                                if (newValue != null && newValue.isNotEmpty) {
                                                  ...
                                                  if (newItem['product']['_id']?.isNotEmpty == true) {
                                                    existingProductIds.remove(newItem['product']['_id']);
                                                  }
                                                  newItem['product'] = {'_id': '', 'name': ''};
                                                }
                                              });
